// ==UserScript==
// @name         Spacom.ru ShowFleet
// @version      0.0.1
// @namespace    http://dimio.org/
// @description  Some improvements on fleet window
        ...
        showShipsCount() {
            ...
            w.Addons.waitFor(w.$('#ships_info'), 'length', () => {
                ...
                w.$('.fleet_ico_container').each(
                    function(){
                        w.$(this).append( shipCount[ w.$(this).children('img').attr('src').split('/')[3] ] );
                    }
                )
            })
        },
