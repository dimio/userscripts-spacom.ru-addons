...
+ ### Подписка (премиум)
    * [Spacom.Addons.Premium.AnomalyView](./Addons/Premium/AnomalyView.user.js): добавляет сортировку и поиск/фильтрацию в таблице "Обзор аномалий" (например - позволяет удобно просмотреть свободные аномалии). Использует внешнюю библиотеку [DataTables](https://datatables.net/).
